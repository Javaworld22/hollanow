    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  mLoginButton = (Button) rootView.findViewById(R.id.sign_in_button);
       // mSignUpButton = (Button) rootView.findViewById(R.id.sign_up);
        ...
        mFacebookLogin = (LoginButton)rootView.findViewById(R.id.login_button);
       ...
       // mFacebookLogin.setReadPermissions(Arrays.asList("public_profile", "email"));
        ...
        mFacebookLogin.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                Log.e(TAG+" ","Facebook Picture String is 2: "+loginResult.getAccessToken());
                Log.e(TAG+" ","Facebook Picture String is 2: "+loginResult.getAccessToken().getUserId());

            }

            @Override
            public void onCancel() {
                Log.e(TAG+" ","Facebook Picture canceled: ");
               // Log.e(TAG+" ","Facebook Picture canceled ");
            }

            @Override
            public void onError(FacebookException error) {
                Log.e(TAG+" ","Facebook Picture String is 2: "+error.getMessage());
                Log.e(TAG+" ","Facebook Picture String is 2: "+error.getMessage());
            }
        });
        ...
        LoginManager.getInstance().registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            @Override
            public void onSuccess(LoginResult loginResult) {
                Log.e(TAG+" ","Facebook Picture String is 3: "+loginResult.getAccessToken());
               // Log.e(TAG+" ","Facebook Picture String is 3: "+loginResult.getAccessToken().getUserId());
                ...
                parameter.putString("fields", "id,first_name,last_name,email,gender");
            ...
            @Override
            public void onCancel() {
                Log.e(TAG+" ","Facebook Picture canceled 4: ");
                Log.e(TAG+" ","Facebook Picture canceled  4");
            }

            @Override
            public void onError(FacebookException error) {
                Log.e(TAG+" ","Facebook Picture String is 5: "+error.getMessage());
                Log.e(TAG+" ","Facebook Picture String is 5: "+error.getMessage());
        ...
        mFacebookLogin.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Log.e(TAG+" ","Facebook Button clicked: ");
               // Log.e(TAG+" ","Facebook Button clicked: ");
               // Log.e(TAG+" ","Facebook Button clicked: ");
                ...
                perm.add("user_friends");
                    ...
                    perm.add("email");
                    perm.add("user_photos");
                LoginManager.getInstance().logInWithReadPermissions(getActivity(),perm);
            }
        });
                ...
                if (MyToolBox.isNetworkAvailable(getContext())) {
                    ...
                    if (!MyToolBox.isMinimumCharacters(mPassword.getText().toString(), 2)) {
                        ...
                        if(flag_login) {
                            ...
                            // Use this when login has fault
                           // User user = new User("iheruomemichael@gmail.com","javaworld");
                           // user.setUsername("Javaworld");
...
//                        Toast.makeText(LoginActivity.this, response.body().getToken()+"", Toast.LENGTH_LONG).show();
                        ...
                        Log.e(TAG, "response: " + response.body() + " code: " + response.code());
                        Toast.makeText(mContext, "Server Exception. Try again", Toast.LENGTH_LONG).show();
                        mProgressDialog.dismiss();
                    }else{
                        Log.e(TAG, "response: " + response.body() + " code: " + response.code());
                ...
                public void onFailure(Call<User> call, Throwable t) {
                   ...
                   // Toast.makeText(mContext, "Wrong Username/Password", Toast.LENGTH_LONG).show();
                    ...
                    if(t instanceof ConnectException) {
                        Toast.makeText(mContext, "Connection Exception!!", Toast.LENGTH_LONG).show();
...
//                Log.e(TAG, "user details failed: " + t.getMessage());
    ...
    private Bundle getFacebookData(JSONObject object){
        ...
        try{
            ...
            Log.e(TAG, "Bundle exception: " + a.getMessage());
        }
        return bundle;
    }

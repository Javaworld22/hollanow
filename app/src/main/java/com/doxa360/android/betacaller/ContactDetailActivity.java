...
public class ContactDetailActivity extends AppCompatActivity {
    ...
    private HollaContactAdapter mAdapter;
...
//                placeCall(contactPhone);// not among
        ...
        mHollanowInvite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               // ParseQuery<ParseUser> query = ParseUser.getQuery();
                ...
                sendSMSIntent(contactPhone, "Hi, let's make smart calls by exchanging expression whenever we call each other. Install link http://bit.ly/2rDEq84. Holla @"+/**ParseUser.getCurrentUser().getUsername()**/ pref.getUsername().toString().trim());
            }
        });
  ...
  /**  private void setCallHistoryUI() {
        ...
        if (callLogs!=null && callLogs.size()!=0) {
            mEmptyText.setText("");
            mAdapter = new HollaContactAdapter(callLogs, this, false);

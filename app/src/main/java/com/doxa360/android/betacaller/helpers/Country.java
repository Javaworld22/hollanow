...
/**
 * Created by hollanow on 9/1/2017.
 */
...
class Country implements Comparable<Country> {
    ...
    public static List<Country> getLibraryMasterCountriesEnglish() {
        ...
        countries.add(new Country("sv", "503", "ElSalvador"));
        ...
        countries.add(new Country("fo", "298", "FaroeIslands"));
        ...
        countries.add(new Country("md", "373", "Republic_Of_Moldova"));
        ...
        countries.add(new Country("nz", "64", "NewZealand"));
        ...
        countries.add(new Country("kp", "850", "NorthKorea"));
        ...
        countries.add(new Country("sm", "378", "SanMarino"));
        countries.add(new Country("st", "239", "Sao Tome And Principe"));
        countries.add(new Country("sa", "966", "SaudiArabia"));
        ...
        countries.add(new Country("sl", "232", "SierraLeone"));
        countries.add(new Country("sg", "65", "Singapore"));
        countries.add(new Country("sx", "1", "SintMaarten"));
        ...
        countries.add(new Country("za", "27", "SouthAfrica"));
        countries.add(new Country("kr", "82", "SouthKorea"));
        countries.add(new Country("es", "34", "Spain"));
        countries.add(new Country("lk", "94", "SriLanka"));
        ...
        countries.add(new Country("gb", "44", "UnitedKingdom"));
        countries.add(new Country("ua", "380", "Ukraine"));
        countries.add(new Country("uy", "598", "Uruguay"));
        countries.add(new Country("us", "1", "UnitedStates"));
        countries.add(new Country("vi", "1", "US_Virgin_Islands"));
        countries.add(new Country("uz", "998", "Uzbekistan"));
        countries.add(new Country("vu", "678", "Vanuatu"));
        countries.add(new Country("va", "39", "Holy See (vatican_City_State)"));
        countries.add(new Country("ve", "58", "Bolivarian_Republic_Of_Venezuela"));
        countries.add(new Country("vn", "84", "VietNam"));
        countries.add(new Country("wf", "681", "Wallis_And_Futuna"));
    ...
    public boolean isEligibleForQuery(String query) {
        ...
        Log.e(TAG, "Name of Country is : "+query+" "+getName()+" "+getNameCode()+" "+getPhoneCode()+" "+getEnglishName());
